...
To resolve this issue our application code will need to be refactored to remove the RMI calls, we've done this already in another branch which we'll use to deploy to OpenShift.
