...
Operator need to be installed by a user with the cluster admin role.  Login to OpenShift as a cluster admin and navigate to Operators -> Operator hub.
...
Paste the following yaml tto configure the deployment
